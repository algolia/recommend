...
```sh
yarn add @algolia/recommendations-js@experimental
# or
npm install @algolia/recommendations-js@experimental
```
...
/** @jsx h */
import { h } from 'preact';
import { frequentlyBoughtTogether } from '@algolia/recommendations-js';
import algoliasearch from 'algoliasearch';

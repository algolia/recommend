...
```sh
yarn add @algolia/recommendations-react@experimental
# or
npm install @algolia/recommendations-react@experimental
```
...
```jsx
import { useRelatedProducts } from '@algolia/recommendations-react';
import algoliasearch from 'algoliasearch';
...
```jsx
import { useFrequentlyBoughtTogether } from '@algolia/recommendations-react';
import algoliasearch from 'algoliasearch';
...
```jsx
import { useRecommendations } from '@algolia/recommendations-react';
import algoliasearch from 'algoliasearch';
